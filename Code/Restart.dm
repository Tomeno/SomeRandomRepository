	...
	if(!ASK)
		...
		if(client)
			...
			switch(Race)
				...
				if("Dragon - Rare") alert(src,"A legendary dragon. That's you. Soon however you will be more than that, you'll be a mother. Before that time comes you'll need to find a suitable location to make your home.")
				...
				if("Svartalfar - Rare") alert(src,"A Dark God of another land has destroyed your family, and cursed you with longevity and power, only to warp your appearance and seperate you from the rest of mankind.")
				...
				if("Dragon - Rare") alert(src,"Travelling far from your hatching ground you have arrived in this new land to make your home.")
				if("Devourer - Rare")
